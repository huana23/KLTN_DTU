<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-content">
        <form action="{{ route('admin.subject.update', $oneSubject->id) }}" method="POST">
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text"  name="tenMonHoc" class="form-control" value="{{ $oneSubject->tenMonHoc }}"  placeholder="Nhập tên môn học">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text"name="meTa" value="{{ $oneSubject->meTa }}"  class="form-control"  placeholder="Nhập họ mô tả">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
