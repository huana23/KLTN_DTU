<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="page-content">
        <form action="{{ route('admin.class.update', $oneClass->id) }}" method="POST">
            @csrf
            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger">(*)</span>
                                                ...
                                                <input type="text"  name="tenKhoi" value="{{ $oneClass->tenKhoi }}" class="form-control" placeholder="Nhập tên lớp học">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="" class="control-label text-right">Mô tả
                                                ...
                                                <input type="text" name="meTa" value="{{ $oneClass->meTa }}" class="form-control" placeholder="Nhập mô tả">
                                        </div>
                                    </div>
                                </div>
